  ...
  return (
    <>
      ...
      >
        ...
        />
        <div
          className="relative z-10 max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl border border-border-default bg-surface-raised p-6 shadow-2xl"
          role="dialog"
          aria-modal="true"
            ...
            <div className="w-full">
              {isLoadingHistory ? (
                ...
                <div className="rounded-lg bg-surface-inset p-3">
                  ...
                  <PriceChart priceHistory={priceHistory} title="Market Price" variant="dark" />
                </div>
              ) : (
  ...
  return (
    <CardModalContext.Provider value={value}>
      ...
      {isPokemon && (
        <InvestmentModal
          card={pokemonCard}
          isOpen={Boolean(cardId && pokemonCard)}
          onClose={closeCard}
        />
      )}
      {isOnePiece && (
