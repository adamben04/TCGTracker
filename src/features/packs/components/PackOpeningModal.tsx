...
export const PackOpeningModal: React.FC<PackOpeningModalProps> = ({
  ...
  const getRarityColor = (rarity?: string) => {
    ...
    if (r.includes('secret') || r.includes('rainbow'))
      return 'from-yellow-400 via-amber-300 to-orange-400';
  ...
  return (
    <Modal
      ...
      size="pack"
      footer={footer}
      ariaLabel={`${pack.name} pack opening`}
    >
        ...
        {stage === 'prep' && (
          <div className="flex h-full flex-col items-center justify-center gap-5 pb-2 sm:gap-6">
            ...
            <div className="text-center">
              <h2 className="text-3xl font-black text-ink-primary sm:text-4xl">{pack.name}</h2>
        ...
        {stage === 'results' && packPull && (
          <div className="flex h-full flex-col gap-4 pb-1 sm:gap-5">
            <div className="shrink-0 text-center">
              <h3 className="text-2xl font-black text-ink-primary sm:text-3xl">Pack Opened!</h3>
